...
namespace PylonC.NETSupportLibrary
{
    ...
    public class ImageProvider
    {
        ...
        protected uint m_numberOfBuffersUsed = 4;          /* Number of m_buffers used in grab. */
        ...
        public ImageProvider()
        {
			...
			//Console.WriteLine ("IMG: " + m_grabThread.ManagedThreadId);
		...
		public Action ImageReadyAction;
